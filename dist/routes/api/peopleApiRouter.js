...
router.put('/:id', idNotFound, cdnUpload.single('file'), PeopleController.updatePeople);
...
router.post('/cdn-upload', cdnUpload.single('file'), PeopleController.cdnUploadImage);
export default router;
//# sourceMappingURL=peopleApiRouter.js.map